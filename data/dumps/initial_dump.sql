...
INSERT INTO `categories` VALUES (1,1,1,4,'example-root-category','Example Root Category','The Example Root Category is the root category for all sample data categories','/img/no_thumbnail.png','2013-04-23 21:49:21','2013-04-23 21:49:21'),(2,1,2,3,'example-child-category','Example Child Category','The Example Child Category is the a child category of the Example Root Category','/img/no_thumbnail.png','2013-04-23 21:49:21',NULL),(3,3,1,8,'use-case-root-category','Use Cases','The Use Case Root Category is the root category for all use case categories','/img/no_thumbnail.png','2013-04-23 21:49:21','2013-04-23 21:49:21'),(4,3,2,3,'use-case-device-category','Device','The Device Category is the a child category of the Use Case Root Category','/img/no_thumbnail.png','2013-04-23 21:49:21',NULL),(5,3,4,5,'use-case-user-category','User','The User Category is the a child category of the Use Case Root Category','/img/no_thumbnail.png','2013-04-23 21:49:21',NULL),(6,3,6,7,'use-case-customer-category','Customer','The Customer Category is the a child category of the Use Case Root Category','/img/no_thumbnail.png','2013-04-23 21:49:21',NULL);
...
INSERT INTO `use_case_priorities` VALUES (1,'High','2013-04-23 21:49:21',NULL),(2,'Normal','2013-04-23 21:49:21',NULL),(3,'Low','2013-04-23 21:49:21',NULL);
...
INSERT INTO `use_case_types` VALUES (1,'Business Use Case','2013-04-23 21:49:21',NULL),(2,'System Use Case','2013-04-23 21:49:21',NULL);
...
CREATE TABLE `use_cases` (
  ...
  `input_data` longtext COLLATE utf8_unicode_ci,
  `output_data` longtext COLLATE utf8_unicode_ci,
  `created_at` datetime NOT NULL,
  `updated_at` datetime DEFAULT NULL,
  PRIMARY KEY (`id`),
...
-- Dump completed on 2013-04-23 21:49:32
